...
class ResultCoord implements Coordinator {
    ...
    private DeptOffice dept;
    private CtrlOffice ctrl;
    private DSW dsw;
    ...
    @Override
    public void register(DeptOffice dept) {
        this.dept = dept;
    }

    @Override
    public void register(CtrlOffice ctrl) {
        this.ctrl = ctrl;
    }

    @Override
    public void register(DSW dsw) {
        this.dsw = dsw;
    }
    ...
    public void certificate(String id) {
        ...
        if (!s.confirmed || !s.orderIssued || !s.testimonialIssued) {
            System.out.println(
                    "[Coordinator] REJECTED: Previous steps are incomplete.");
            return;
        }
    ...
    public void status(String id) {
        ...
        System.out.println(
                "[Coordinator] Status of " + student.getId() + ": "
                        + states.get(id));
    }
