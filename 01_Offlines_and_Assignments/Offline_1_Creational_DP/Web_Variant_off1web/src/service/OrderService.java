 ...
 *
 * Every Order and OrderItem below is assembled through its Builder. Each
 * factory method only sets the fields that differ from FoodFlow's default
 * policy (centralized in Order.Builder / OrderItem.Builder). No default
 * value is repeated here, and no call site depends on parameter position.
 */
